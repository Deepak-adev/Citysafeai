    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-4 sm:space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-foreground">Police Portal</h1>
          <p className="text-sm sm:text-base text-muted-foreground px-2">Access your law enforcement dashboard</p>
        </div>
